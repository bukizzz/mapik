...
<template>
  <footer class="app-footer">
    <div class="footer-container">
      <!-- Glavna oblast informacija -->
      <div class="footer-main">
        <span class="project-info">
          <a href="https://github.com/bukizzz/MAPIK" target="_blank" rel="noopener noreferrer">
            <b>MAPIK</b>
          </a>
        </span>
          ...
          <n-tooltip trigger="hover" placement="top">
            <template #trigger>
              ...
              >
                ...
                <span>{{ t("footer.links.feedback") }}</span>
              </a>
            </template>
            {{ t("footer.tooltips.feedback") }}
          </n-tooltip>
        </div>
...
/* Oblast informacija o autorskim pravima */
.copyright-container {
  display: flex;
  align-items: center;
  gap: 8px;
