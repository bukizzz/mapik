    ...
    <n-card class="group-list-card modern-card" :bordered="false" size="small">
      ...
      <div class="search-section">
        <n-input
          ...
          :placeholder="t('keys.groupList.searchPlaceholder')"
          size="small"
          clearable
        >
          <template #prefix>
        ...
        <n-spin :show="loading" size="small">
          <div v-if="filteredGroups.length === 0 && !loading" class="empty-container">
            <n-empty
              size="small"
              :description="
                searchText ? t('keys.groupList.noResults') : t('keys.groupList.noGroups')
              "
            />
          </div>
