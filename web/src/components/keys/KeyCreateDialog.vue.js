...
async function handleSubmit() {
    ...
    try {
        ...
        resetForm();
        handleClose();
        window.$message.success(t("keys.keyCreate.importTaskStarted"));
...
const __VLS_10 = __VLS_asFunctionalComponent(__VLS_9, new __VLS_9({
    ...{ style: {} },
    title: (__VLS_ctx.t('keys.keyCreate.title', { groupName: __VLS_ctx.groupName || __VLS_ctx.t('keys.keyCreate.currentGroup') })),
    bordered: (false),
    size: "huge",
    role: "dialog",
    'aria-modal': "true",
...
const __VLS_26 = __VLS_asFunctionalComponent(__VLS_25, new __VLS_25({
    ...
    type: "textarea",
    placeholder: (__VLS_ctx.t('keys.keyCreate.placeholder')),
    rows: (8),
    ...{ style: {} },
}));
...
}, ...__VLS_functionalComponentArgsRest(__VLS_26));
{
    ...
    (__VLS_ctx.t("keys.keyCreate.cancel"));
    var __VLS_32;
    ...
    (__VLS_ctx.t("keys.keyCreate.create"));
    var __VLS_40;
}
var __VLS_12;
var __VLS_3;
