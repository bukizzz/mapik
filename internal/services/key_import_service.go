...
// KeyImportResult sadrži rezultat zadatka uvoza.
type KeyImportResult struct {
	AddedCount   int `json:"added_count"`
	IgnoredCount int `json:"ignored_count"`
}

// KeyImportService obrađuje asinhroni uvoz velikog broja ključeva.
type KeyImportService struct {
	TaskService *TaskService
	KeyService  *KeyService
}

// NewKeyImportService kreira novi KeyImportService.
...
// StartImportTask pokreće novi asinhroni zadatak uvoza ključeva.
