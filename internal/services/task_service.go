...
// TaskStatus predstavlja pun životni ciklus dugotrajnog zadatka.
...
// TaskService upravlja stanjem jednog, globalnog, dugotrajnog zadatka koristeći interfejs skladišta.
type TaskService struct {
	store store.Store
}

// NewTaskService kreira novi TaskService.
...
// StartTask pokušava da pokrene novi zadatak. Vraća grešku ako je zadatak već pokrenut.
...
// GetTaskStatus vraća trenutni status zadatka.
...
// UpdateProgress ažurira napredak trenutnog zadatka.
...
// EndTask označava trenutni zadatak kao završen i čuva njegov konačni rezultat.
