...
// RequestLogService je odgovoran za upravljanje logovima zahteva.
...
// NewRequestLogService kreira novu instancu RequestLogService.
...
// Start inicijalizuje uslugu i pokreće rutinu periodičnog pražnjenja
...
func (s *RequestLogService) runLoop() {
	...
	// Početno pražnjenje pri pokretanju
	s.flush()
...
// Stop graciozno zaustavlja RequestLogService
...
// Record beleži zahtev u bazu podataka i keš.
...
// flush prebacuje podatke iz keša u bazu podataka
...
// writeLogsToDB upisuje seriju logova zahteva u bazu podataka
